...
function setup() {
  ...
  stand2 = new Stand(800,181,200,10);
 ...
 //level one
  block17 = new Block(740,155,30,40);
  block18 = new Block(770,155,30,40);
  block19 = new Block(800,155,30,40);
  block20 = new Block(830,155,30,40);
  block21 = new Block(860,155,30,40);
  block22 = new Block(770,115,30,40);
  block23 = new Block(800,115,30,40);
  block24 = new Block(830,115,30,40);
  block25 = new Block(800,75,30,40);
  hexa = new Hexa();
  slingshot = new Slingshot(hexa.body,{x:150,y:290});
 }
function draw() {
  background(56,44,44); 
